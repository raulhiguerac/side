...
from app.services.auth.adapters.sql_account_repository import SqlAccountRepository
from app.services.auth.adapters.sql_compensation_task import (
    SqlCompensationTaskRepository,
)
from app.services.auth.adapters.sql_profile_repository import SqlProfileRepository
...
class SqlAuthUnitOfWork(AuthUnitOfWork):
    def __init__(self, session: Session) -> None:
        ...
        account_reader: AccountReaderPort = SqlAccountReader(session=session)
        ...
        self.profiles: ProfileWriter = SqlProfileRepository(session=session)

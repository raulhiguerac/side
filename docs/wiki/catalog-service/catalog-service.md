...
- catalog-service es el único microservicio que usa la imagen `postgis/postgis:17-master` en el `docker-compose.yml`; los demás Postgres son `postgres:17` plano.
